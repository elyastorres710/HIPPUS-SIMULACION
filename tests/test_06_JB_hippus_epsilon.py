"""
Prueba: Oscilaciones tipo "pupillary hippus" variando epsilon de EWpg_pred.
...
Objetivo: Investigar cómo el parámetro epsilon de TODOS los bloques afecta
la dinámica del sistema y puede generar oscilaciones tipo "pupillary hippus"
...
# Valores de epsilon para TODOS los bloques
# El valor por defecto es DEFAULT_EPSILON = 0.2
# Valores más altos pueden generar oscilaciones en todo el sistema
EPSILON_VALUES = [0.01, 0.02, 0.20, 0.60]  # bajo, medio, alto
...
for eps in EPSILON_VALUES:
    # Crear sistema fresco para cada valor de epsilon
    system = JohanssonBalkeniusSystem("default")
    
    # Modificar epsilon de TODOS los bloques
    ...
    print(f"Simulando con epsilon de TODOS los bloques = {eps:.2f}...")
...
gs = gridspec.GridSpec(len(EPSILON_VALUES) + 1, 1, hspace=0.4)
...
data_first = results[EPSILON_VALUES[0]]
...
# --- Paneles 2-4: Diámetro pupilar para diferentes epsilons ---
colors = ['lightblue', 'orange', 'red']
labels = ['ε=0.01 (muy bajo)', 'ε=0.02 (bajo)', 'ε=0.20 (normal)', 'ε=0.60 (alto)']
